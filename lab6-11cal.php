...
<?php
    ...
    if ($total >= 80) echo "<img src=img/A.jpg width=100px><br>";
    elseif ($total >= 70) echo "<img src=img/B.jpg width=100px><br>";
    elseif ($total >= 60) echo "<img src=img/C.jpg width=100px><br>";
    elseif ($total >= 50) echo "<img src=img/D.jpg width=100px><br>";
    else echo "<img src=img/F.jpg width=100px><br>";
    echo "<br>";
